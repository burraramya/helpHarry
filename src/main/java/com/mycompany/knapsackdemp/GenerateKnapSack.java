...
public class GenerateKnapSack {
    ...
    private int[] mode1MaxWeights = {100,100,100,100,100,100,100,100,100,100};
    private int[][] mode1Weights = {{10,15,35,40,1,5,20,55,25,30},
                                    {10,15,35,40,1,5,20,55,25,30},
                                    {10,15,35,40,1,5,20,55,25,30},
                                    {10,15,35,40,1,5,20,55,25,30},
                                    {10,15,35,40,1,5,20,55,50,30},
                                    {10,15,55,40,1,5,20,35,50,30},
                                    {10,15,55,40,1,5,20,35,50,30},
                                    {10,15,55,40,1,5,20,35,50,30},
                                    {10,15,55,40,1,5,20,35,50,30},
                                    {10,15,55,40,1,5,20,35,50,30}};

    private int[][] mode1Values = {{20,10,15,40,5,5,15,35,20,10},
                                    {40,10,20,40,10,15,5,35,45,10},
                                    {5,10,20,35,10,15,45,60,50,10},
                                    {5,10,20,35,10,15,45,60,50,10},
                                    {5,10,20,35,10,15,45,60,55,10},
                                    {20,25,90,35,5,15,40,40,80,10},
                                    {40,25,20,10,5,15,45,30,15,10},
                                    {5,25,20,30,5,45,35,30,15,5},
                                    {5,25,20,30,5,45,35,30,15,25},
                                    {25,15,80,30,5,45,30,35,45,25}};
