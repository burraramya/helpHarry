...
public class KnapSackDemo extends javax.swing.JFrame {
    ...
    // private void weightButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_weightButton1ActionPerformed
    //     // TODO add your handling code here:
    //     if(weightPanels[0].isVisible()) {
    //         weightPanels[0].setVisible(false);
    //         currentWeight= currentWeight- 10; 
    //         currentValue = currentValue -9; 
    //         emptyPanelLength = emptyPanelLength + 200;
    ...
    //         currentValueLabel.setText("Current Value: " + currentValue);
            
            
            
    //     }else {
    //         weightPanels[0].setVisible(true);
    //         weightPanels[0].setSize(120,200);
    //         weightPanels[0].setMaximumSize(new Dimension(120,200));
    //         emptyPanelLength = emptyPanelLength - 200;
    //         emptyPanel.setSize(120,emptyPanelLength);
    //         emptyPanel.setMaximumSize(new Dimension(120,emptyPanelLength));
    ...
    // private void weightButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weightButton2ActionPerformed
    //     // TODO add your handling code here:
        
    //         if(weightPanels[1].isVisible()) {
    //         weightPanels[1].setVisible(false);
    ...
    //         if(currentWeightCheck(currentWeight+ 15)) {
    //             JOptionPane.showMessageDialog(this, "The Maximum weight can be only : " + maxWeight);
    //         } else {
    //         weightPanels[1].setVisible(true);
    //         weightPanels[1].setSize(120,200);
    //         weightPanels[1].setMaximumSize(new Dimension(120,200));
    //         emptyPanelLength = emptyPanelLength - 200;
    //         emptyPanel.setSize(120,emptyPanelLength);
    //         emptyPanel.setMaximumSize(new Dimension(120,emptyPanelLength));
    //         currentWeight= currentWeight+ 15; 
    ...
    //         }
    //     }
    // }//GEN-LAST:event_weightButton2ActionPerformed
